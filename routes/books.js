...
async function renderNewPage(res, book, hasError = false){
    try{
        ...
        if (hasError) params.errorMessage = 'Erro ao criar livro.' //Se encontrar erro cria o parâmetro errorMessage
        res.render('books/new', params) //Renderiza a página de novos livros passando todos os autores e o novo livro vazio
    }catch{
        res.redirect('/books')
    }
}
